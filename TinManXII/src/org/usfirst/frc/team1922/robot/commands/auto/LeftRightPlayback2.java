 ...
 *
 */
public abstract class LeftRightPlayback2 extends Command {
    ...
    public LeftRightPlayback2(String leftFilePath1, String rightFilePath1, String leftFilePath2, String rightFilePath2) {
    ...
    protected void execute() {
    	execute(_leftPlayback1.GetSetpoint(), _rightPlayback1.GetSetpoint(), 
    			_leftPlayback2.GetSetpoint(), _rightPlayback2.GetSetpoint());
    }
    ...
    protected boolean isFinished() {
        return _leftPlayback1.IsFinished() || _leftPlayback2.IsFinished();
    }
